...
const CashierSidebar: React.FC<CashierSidebarProps> = ({ onItemClick }) => {
          ...
          {defaultCashierSidebarItems.map((item) => {
            ...
            return (
              <Link
                ...
                to={item.href}
                onClick={onItemClick}
                className={`group flex items-center justify-between w-full px-3.5 py-3 text-sm font-semibold rounded-2xl transition-all duration-200 ${isActive
