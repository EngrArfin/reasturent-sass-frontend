...
import ServeSidebar from "@/components/Serve/Shared/ServeSidebar";
import ServeNavBar from "@/components/Serve/Shared/ServeNavBar";

const ServeLayout: React.FC = () => {
    ...
    <div className="flex h-screen overflow-hidden bg-[#121826] text-white">
      ...
      <div className="flex flex-col flex-1 lg:ml-64 min-w-0 transition-all duration-200 ease-in-out">
        ...
        <div className="fixed top-0 left-0 lg:left-64 right-0 z-20">
          <ServeNavBar onMobileMenuToggle={handleMobileMenuToggle} />
        </div>
        ...
        <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
          ...
          >
            <ServeSidebar onItemClick={() => setIsMobileMenuOpen(false)} />
          </SheetContent>
        </Sheet>
