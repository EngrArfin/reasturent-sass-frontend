...
import CashierDashboardNavBar from "@/components/CashierDashboard/Shared/CashierDashboardNavBar";
import CashierSidebar from "@/components/CashierDashboard/Shared/CashierSidebar";
    ...
    <div className="flex h-screen overflow-hidden bg-[#121826] text-white">
      ...
      <div className="flex flex-col flex-1 lg:ml-64 min-w-0 transition-all duration-200 ease-in-out">
        ...
        <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
          ...
          <SheetContent side="left" className="w-72 p-0 bg-[#131b2e] border-r border-[#1F2E4D]">
            <CashierSidebar onItemClick={() => setIsMobileMenuOpen(false)} />
          </SheetContent>
        </Sheet>
